...
listening_sock.bind((SERVER_ADDR, SERVER_PORT[1]))
...
while True:
    ...
    if(t>0 and intera):
        ...
        if msg[1] > 1:
            ...
            # else:
            #     data_size_h = msg[1]
        print("receive the h is {}".format(data_size_h))
        print("msg[1] is {}".format(msg[1]))
        #print("msg_pre is {}".format(msg_pre))
        msg_pre = msg[1]   # 存一下之前的
    ...
    print('*** Number of  data is {}'.format(int(round(data_size_h))))
